if CodeBuddy.vpRegisterContext and ( StateName == "SelectCivilization" or StateName == "GameSetupScreen" ) then -- This is very much a hack but there is no other way ( - well, overriding in (3) would work)
	CodeBuddy.vpRegisterContext();
end
...
local ContextPtr = function() return loadstring("return ContextPtr")() end
