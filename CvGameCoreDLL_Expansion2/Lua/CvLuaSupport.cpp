...
"		end\n"
"		env.VPUI_loader = doesIncludeExist('VPUI_loader') and env.ContextPtr:LoadNewContext('VPUI_loader');\n"
"		setfenv(0,_ENV);\n"
"		print('New api context created! ContextPtr:' , env.VPUI_loader or 'NIL?');\n"
"		print('################################################################################');\n"
"		env = coroutine.yield();\n"
"	end\n"
"end);\n"
