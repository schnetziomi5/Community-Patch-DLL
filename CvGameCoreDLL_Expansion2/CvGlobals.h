...
#define STTR_REC_C( FUNCMSG,... ) static DWORD vpdllsttr_dptr = NULL; if(not vpdllsttr_dptr){ static DWORD temp[]{ (DWORD)FUNCMSG,NULL,NULL,__VA_ARGS__}; vpdllsttr_dptr = (DWORD)&temp;}
