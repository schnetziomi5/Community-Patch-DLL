...
#define STTR_1(a) static DWORD vpdllsttr_dptr = 0; if(!vpdllsttr_dptr){ static DWORD temp[]{ (DWORD)__FUNCSIG__,0,0,1,(DWORD)("a"),(DWORD)(&typeid(a))}; vpdllsttr_dptr = (DWORD)&temp;};DWORD vpdllsttr_dat[]{(DWORD)TlsGetValue(STTR::TLS_IDX),vpdllsttr_dptr,STTR::toraw(a)};STTR::STSTRUCT vpdllsttr_obj{vpdllsttr_dat};TlsSetValue(STTR::TLS_IDX,&vpdllsttr_obj);
